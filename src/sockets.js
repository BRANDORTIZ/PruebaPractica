...
myHeaders.append("apikey", "p7ZID4uA9Ua6sEuluLuezqgQcjaEqLHC");
...
var USD = fetch("https://api.apilayer.com/currency_data/live?source=USD&currencies=COP", requestOptions)
  .then(response => response.json())
  .then(result => console.log(result.quotes.USDCOP))
